								...
								<div role="tabpanel" class="tab-pane active" id="account-vertical-general"
									...
									<div class="media">
										<a href="javascript: void(0);">
											<img src="@if(!empty(auth()->user()->avatar)){{ asset('storage/' . auth()->user()->avatar) }}@else {{ asset('app-assets/images/portrait/small/default-pp.png') }} @endif" class="rounded mr-75" alt="profile image" height="64" width="64">
										</a>
